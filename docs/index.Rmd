...
.fade[Hi, this is Mauro . I hope you and your loved ones are safe.] __I'm writing to ask if you would be willing to review a package for rOpenSci.__ .fade[As you probably know, rOpenSci conducts peer review of R packages contributed to our collection in a manner similar to journals.]

__The package targets by Will Landau provides make-like pipelines for R.__ .fade[targets supersedes drake, and is submitted to rOpenSci jointly with the package tarchetypes. You can find targets and tarchetypes on GitHub here and here. We conduct our open review process via GitHub as well.]
