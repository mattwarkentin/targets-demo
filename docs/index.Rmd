...
.b[Patterns:] Creates .i.blue[branches] by iterating over function arguments
...
__Iteration__: patterns iterate over arguments (e.g. using `map()`), and there are two important aspects of iteration...
...
● run branch model_0b45f3c6
● run branch model_f4b18a5b
Master: [12.1s 75.5% CPU]; Worker: [avg 19.9% CPU, max 8387926.0 Mb]
```
...
<br><br><br>
.ba.pa3.br3.bg-yellow.f4.center.shadow-5[.b[Kohn's Second Law:] An experiment is reproducible until another laboratory tries to repeat it]
<br><br>
.ba.pa3.br3.bg-light-green.f4.center.shadow-5[.b[Matt's Second Law:] A statistical analysis is reproducible until you try to re-run it ~~years~~ days later]
