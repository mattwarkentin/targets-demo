...
```{r echo=FALSE}
htmltools::div("A unique name given to a target. TIP: A common prefix can make it easier to refer to families of targets", class = "name-tip w-30 absolute ba pa2 br3 z-1 tc bg-green white tip-reveal  shadow-4 bw1 b--black")

htmltools::div("The R code that produces the target value", class = "command-tip w-30 absolute ba pa2 br3 z-2 tc bg-blue white tip-reveal shadow-4 bw1 b--black")
```
...
```{r echo=FALSE}
htmltools::div("A character vector of packages that will be loaded before building your pipeline", class = "pkg-tip w-30 absolute ba pa2 br3 z-1 tc bg-red white tip-reveal shadow-4 bw1 b--black")
```
