...
.fade[Hi, this is Mauro . I hope you and your loved ones are safe.] .b.engorge[I'm writing to ask if you would be willing to review a package for rOpenSci.] .fade[As you probably know, rOpenSci conducts peer review of R packages contributed to our collection in a manner similar to journals.]

.b.engorge[The package targets by Will Landau provides make-like pipelines for R.] .fade[targets supersedes drake, and is submitted to rOpenSci jointly with the package tarchetypes. You can find targets and tarchetypes on GitHub here and here. We conduct our open review process via GitHub as well.]
...
<br><br>
.ba.pa3.br3.bg-light-green.f4.center.shadow-5[.b.f3[Matt's Second Law:] A statistical analysis is reproducible until you try to re-run it ~~years~~ days later]
